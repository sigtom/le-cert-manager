...
Use the previously provided commands to review the prod certificate, confirm its been issued from the prod endpoint, and it include the domain(s) you requested. 
